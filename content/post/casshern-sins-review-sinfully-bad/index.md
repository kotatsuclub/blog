...
cover = "assets/TSOGGdKMR.jpg"
title = "Casshern Sins Review - Sinfully Bad"
+++


{{<figure src="assets/TSdGGOFGgz.jpg">}}
...
{{<figure src="assets/oIOMGOKGgm.jpg" caption="*Fortunately, as a ginger, I am immune to this soul-eating stare.*">}}
...
{{<figure src="assets/TSOGMOFGRZ.jpg" caption="*I am a morally complex and sympathetic protagonist. You can tell by how I look into the camera.*">}}
...
{{<figure src="assets/oSOMMdKGRM.jpg" caption="*He could've made a killing as a model with that pose.*">}}
...
{{<figure src="assets/oSOGGOFGR7.png" caption="*Simple: I'm here to kill you.*">}}
...
{{<figure src="assets/oSOGGdFGRV.png">}}

{{<figure src="assets/oIdMGOFMRI.png">}}

{{<figure src="assets/TSOGGOFMgN.png" caption="*...what?*">}}
...
{{<figure src="assets/TIOGMOFGRv.png" caption="*Not even a RoboDog can save this one.*">}}
...
{{<figure src="assets/oSdGMdKMRO.jpg" caption="*Come back later, kid. I'm brooding.*">}}
